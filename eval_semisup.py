...
#### main parameters ####
#########################
parser.add_argument("--exp_name", type=str, default="non_linear_probe",
...
parser.add_argument("--train_percent", type=str, default="10", choices=["1", "10"],
...
def main():
    ...
    subset_file = urllib.request.urlopen("https://raw.githubusercontent.com/google-research/simclr/master/imagenet_subsets/" + str(args.train_percent) + "percent.txt")
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        scores_val = validate_network(val_loader, model, epoch)
    ...
    logger.info("Fine-tuning with {}% of labels completed.\n"
                ...
                args.train_percent, acc1=best_acc[0], acc5=best_acc[1]))
    if args.rank == 0:
        wandb.finish()
...
def validate_network(val_loader, model, epoch):
    batch_time = AverageMeter()
    losses = AverageMeter()
    top1 = AverageMeter()
    top5 = AverageMeter()
    ...
    if args.rank == 0:
        ...
        stats = dict(
            ...
            acc1=top1.avg,
            acc5=top5.avg,
            best_acc1=best_acc[0],
            best_acc5=best_acc[1],
        )
        wandb.log(stats)
